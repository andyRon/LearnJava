...
public class RegUtils {
	...
	public static void main(String[] args) {
		System.out.println(isZipCode("00012"));
		findZipCode("邮编 100013，电话18612345678");

		System.out.println(isMobilePhone("018612345678"));
		System.out.println(isMobilePhone("+86 18612345678"));
		System.out.println(isMobilePhone("0086 18612345678"));
