...
import com.andyron.service.RoleService;
import com.andyron.service.RoleServiceImpl;
import com.andyron.service.UserService;
import com.andyron.service.UserServiceImpl;
import com.andyron.util.Constants;
import com.andyron.util.PageSupport;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (method != null) {
            switch (method) {
                ...
                case "view":
                    this.getUserById(req, resp, "userview.jsp"); break;
                case "modify":
                    this.getUserById(req, resp, "usermodify.jsp"); break;
                case "modifysave":
                    this.modify(req, resp); break;
                case "deluser":
                    this.delUser(req, resp); break;
                case "getrolelist":
                    this.getRoleList(req, resp); break;
                case "ucexist":
                    this.userCodeExist(req, resp); break;
                case "pwdmodify":
                    this.getPwdByUserId(req, resp); break;
                case "savepwd":
                    this.updatePwd(req, resp); break;
                default:
                    break;
            }
        }
